apos.define('shooting-star', {
    ...
    construct: function (self, options) {
        ...
        self.convert = function (object, name, $field, $el, field, callback) {
            ...
            object[name] = {
                priority: self.selectRate !== null ? self.selectRate : $rating.find("input[name='rating-" + name.toLowerCase() + "']:checked").attr("data-rate"),
                value: self.selectValue !== null ? self.selectValue : parseFloat($rating.find("input[name='rating-" + name.toLowerCase() + "']:checked").val())
            }
